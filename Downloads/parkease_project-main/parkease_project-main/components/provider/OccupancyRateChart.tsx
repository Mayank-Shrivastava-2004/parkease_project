    ...
    return (
        <View className="bg-white rounded-3xl p-5 shadow-sm shadow-gray-200 border border-gray-100">
            <View className="flex-row justify-between items-center mb-4">
                <View>
                    <Text className="text-dark-900 font-bold text-lg">Occupancy Rate</Text>
                    <Text className="text-gray-400 text-xs mt-1">Real-time status</Text>
                </View>
                <View className="bg-indigo-50 px-3 py-1.5 rounded-xl">
                    <Text className="text-indigo-600 font-bold text-xs">Live</Text>
                </View>
            </View>
            ...
            <View className="items-center py-6">
                <View style={{ width: size, height: size }} className="items-center justify-center">
                    ...
                    <View className="absolute items-center">
                        <Text className="text-4xl font-black text-indigo-600">{occupancyPercentage.toFixed(0)}%</Text>
                        <Text className="text-gray-400 text-xs font-bold uppercase tracking-wide mt-1">Occupied</Text>
                    </View>
                </View>
            </View>
            ...
            <View className="gap-3 mt-4">
                ...
                >
                    <View className="flex-row items-center">
                        ...
                        <Text className="text-dark-900 font-bold">Occupied</Text>
                    </View>
                    <Text className="text-indigo-600 font-black text-lg">{occupied}</Text>
                </Animated.View>
                ...
                >
                    <View className="flex-row items-center">
                        ...
                        <Text className="text-dark-900 font-bold">Available</Text>
                    </View>
                    <Text className="text-green-600 font-black text-lg">{available}</Text>
                </Animated.View>
                ...
                >
                    <View className="flex-row items-center">
                        ...
                        <Text className="text-dark-900 font-bold">Total Slots</Text>
                    </View>
                    <Text className="text-gray-600 font-black text-lg">{total}</Text>
                </Animated.View>
            </View>
        </View>
    );
